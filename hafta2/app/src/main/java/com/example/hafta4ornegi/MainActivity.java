package com.example.hafta4ornegi;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ListView listViewSayilar = findViewById(R.id.listViewSayilar);
        ListView listViewSehirler = findViewById(R.id.listViewSehirler);
        Button btnKontrolEt = findViewById(R.id.btnKontrolEt);
        ...
        listViewSayilar.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                // Eğer kullanıcı inatlaa sol taraftaki sayılara tıklamaya çalışırsa:

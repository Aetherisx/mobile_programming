...
public class CompassSensorActivity extends AppCompatActivity implements SensorEventListener {
    ...
    @Override protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState); setContentView(R.layout.activity_compass_sensor);
        textView = findViewById(R.id.compass_text_view);
    ...
    @Override public void onSensorChanged(SensorEvent event) { textView.setText("Compass: " + event.values[0]); }
